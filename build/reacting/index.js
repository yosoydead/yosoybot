...
function reactionHandler(reaction, user) {
    return __awaiter(this, void 0, void 0, function () {
        var emojiName, username, _a, message;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    _a = emojiName;
                    switch (_a) {
                        case "rubl" /* RUBLERT */: return [3 /*break*/, 1];
                        case "stitch" /* STITCH */: return [3 /*break*/, 3];
                    }
                    return [3 /*break*/, 4];
                case 1: return [4 /*yield*/, rublerts_1.rublertReaction()];
                case 2:
                    message = _b.sent();
